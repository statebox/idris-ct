...
naturalTransformationComposition cat1 cat2 fun1 fun2 fun3 natTrans1 natTrans2 =
    MkNaturalTransformation
      ...
      (\a, b, f =>
        trans  (sym $ associativity cat2 _ _ _ _ (component natTrans1 a) (component natTrans2 a) (mapMor fun3 a b f))
        (trans (cong (compose cat2 (mapObj fun1 a) (mapObj fun2 a) (mapObj fun3 b) (component natTrans1 a)) (commutativity natTrans2 a b f ))
        (trans (associativity cat2 _ _ _ _ (component natTrans1 a) (mapMor fun2 a b f) (component natTrans2 b))
        (trans (cong (\x => compose cat2 _ _ _ x (component natTrans2 b)) (commutativity natTrans1 a b f))
