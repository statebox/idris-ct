module PointedTypes.PointedExtensionalTypesCategory
...
record PointedMorphism (a : PointedObject) (b : PointedObject) where
  ...
  pointedFunc : ExtensionalTypeMorphism (fst a) (fst b)
  pointedFuncRespPoint : (func pointedFunc) (snd a) = snd b

public export
pointedIdentity : (a : PointedObject) -> PointedMorphism a a
pointedIdentity (a' ** x) = MkPointedMorphism (MkExtensionalTypeMorphism id) Refl
...
compose
  ...
  = MkPointedMorphism
    (extCompose a' b' c' f' g')
    (trans (trans (cong (\h => h x) (funcPreserveCompose f' g')) (cong (func g') fxy)) gyz)
...
pointedLeftIdentity
  ...
  = rewrite extLeftIdentity a' b' f' in
    cong (MkPointedMorphism f')
      (trans
        ?asdf
        (leftReflId fxy))
...
--   (b' ** y)
--   (MkPointedMorphism f' fxy)
--   = ?asdf-- cong (MkPointedMorphism f') (trans (rightReflId (cong id fxy)) (congId fxy))
