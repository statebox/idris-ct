...
>   mapMor
>   (\(a1, a2, ()) => Refl)
>   (\(a1, a2, ()), (b1, b2, ()), (c1, c2, ()), (f1, f2, ()), (g1, g2, ()) => Refl)
> where
>   mapObj : obj (productCategory [cat1, cat2]) -> obj (productCategory [cat2, cat1])
>   mapObj (a, b, ()) = (b, a, ())
>
>   mapMor : (a, b : obj (productCategory [cat1, cat2])) -> mor (productCategory [cat1, cat2]) a b
>     -> mor (productCategory [cat2, cat1]) (mapObj a) (mapObj b)
>   mapMor (a1, a2, ()) (b1, b2, ()) (pi1, pi2, ()) = (pi2, pi1, ())
>
> UnitCoherence :
>      (cat : Category)
...
>                   (mapObj tensor (a, b, ()), c, ())
>                   (mapObj tensor (b, a, ()), c, ())
>                   ((component (natTrans symmetry) (a, b, ())), (identity cat c), ()))
>           (compose cat
>                    (mapObj tensor (mapObj tensor (b, a, ()), c, ()))
...
>                            (b, mapObj tensor (a, c, ()), ())
>                            (b, mapObj tensor (c, a, ()), ())
>                            ((identity cat b), (component (natTrans symmetry) (a, c, ())), ())))
>
