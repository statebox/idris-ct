...
> composeFunctorNatTrans _ _ cat3 fun1 fun2 (MkNaturalTransformation component commutativity)
>   fun3 =
>     MkNaturalTransformation
...
>     MkNaturalTransformation
>       (\a => component (mapObj fun1 a))
>       (\a, b, f => commutativity _ _ (mapMor fun1 a b f))
